          ...
          {restaurants.map((restaurant) => (
            <div key={restaurant.id} className="bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-800 mt-2 font-semibold">{restaurant.location}</p>
                <Link to={`/restaurant/${restaurant.id}`} className="mt-4 inline-block bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-400 transition-colors">
                  View Details
                </Link>
              </div>
            </div>
